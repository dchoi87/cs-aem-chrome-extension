...
const Popup = () => {
  ...
  useEffect(() => {
    if (url) {
      ...
      const idx = pathname.indexOf("cedars-sinai");
      const isDispatcher = !pathname.includes("content") && !pathname.includes("cedars-sinai");
      let path;
  ...
  useEffect(() => {
    if (hoverText && path) {
      ...
      switch (hoverText) {
        case "dispatcher":
          targetUrl = `https://www-${env}.cedars-sinai.org/${path}.html`;
          break;
        case "dashboard":
          targetUrl = `https://author-${env}.cedars-sinai.org/sites.html/content/cedars-sinai/${path}`;
          break;
        case "editor":
          targetUrl = `https://author-${env}.cedars-sinai.org/editor.html/content/cedars-sinai/${path}.html`;
          break;
        case "published":
          targetUrl = `https://author-${env}.cedars-sinai.org/content/cedars-sinai/${path}.html?wcmmode=disabled`;
          break;
      }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={classNames(styles.grid, styles.fourCol)}>
        <button className={styles.button} onMouseEnter={() => setHoverText("dashboard")} onMouseLeave={() => setHoverText("")} disabled={!env}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <button className={styles.button} onMouseEnter={() => setHoverText("editor")} onMouseLeave={() => setHoverText("")} disabled={!env}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <button className={styles.button} onMouseEnter={() => setHoverText("published")} onMouseLeave={() => setHoverText("")} disabled={!env}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <button className={styles.button} onMouseEnter={() => setHoverText("dispatcher")} onMouseLeave={() => setHoverText("")} disabled={!env}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
